...
1. make sure you understand how the library should work in DESIGN.md before
...
1. Follow DESIGN.md for public library api
2. If you don't know the exact specs for W3C or OpenTelemetry then search the
   internet!
3. Write idiomatic ocaml 5 with eio
