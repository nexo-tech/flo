...
- [ ] Task 1.14: Write integration tests for core logging flow (Est: 150 LOC)
...
- [ ] Task 2.1: Implement `Flo_format_json` formatter
- [ ] Task 2.2: Implement `Flo_format_logfmt` formatter
